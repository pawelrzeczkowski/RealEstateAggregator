...
namespace RealEstateAggregator.Web.Repositories
{
    ...
    {
        private const string _blackListFile = @"C:\Code\RealEstateAggregator\src\RealEstateAggregator.Web\blacklist.txt";
        private const string _whiteListFile = @"C:\Code\RealEstateAggregator\src\RealEstateAggregator.Web\whitelist.txt";
